package com.saurabhAPIAuto.modules;

import com.github.javafaker.Faker;
import com.google.gson.Gson;
import com.saurabhAPIAuto.pojos.*;
...
public class PayloadManager {
    ...
    public String createPayloadBookingAsString_up() {
        Booking booking = new Booking();
        Faker faker = new Faker();
        booking.setFirstname("Mahatma");
        booking.setLastname("Kumar Gandhi");
        booking.setTotalprice(faker.random().nextInt(1000));
        booking.setDepositpaid(true);
